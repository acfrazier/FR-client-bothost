...
fn rsaenc_java_key_hi_1337() {
    ...
    assert_eq!(
        ...
        &[
            ...
            109, 58, 8, 193, 175, 2, 236, 115, 37, 114, 49, 206, 94, 10, 55, 29, 205, 170, 223,
            128, 245, 135, 72, 178, 150, 234, 153, 197, 241, 204, 145, 159, 190, 42, 207, 8, 85,
            247, 113, 125, 158, 157, 214, 15, 100, 176
        ]
    );
}
