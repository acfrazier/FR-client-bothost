...
impl Pix3DDraw {
    ...
    fn gouraud_raster(
        ...
        if self.low_detail {
                        ...
                        if len < 0 {
                            ...
                            if len > 0 {
                                let rgb = Pix3D::colour_table()
                                    ...
                                    .unwrap_or(0);
                                loop {
                                    surface.pixels[off as usize] = rgb;
                                    off += 1;
                                    len -= 1;
                                    if len <= 0 {
                                        return;
                        ...
                        if len < 0 {
                            ...
                            if len > 0 {
                                ...
                                loop {
                                    ...
                                    surface.pixels[off as usize] = src
            ...
            if self.trans == 0 {
                loop {
                    surface.pixels[off as usize] = Pix3D::colour_table()
                        .get((colour_a >> 8) as usize)
                        .copied()
                        .unwrap_or(0);
                    off += 1;
            ...
            loop {
                ...
                if len < 0 {
                    ...
                    loop {
                        ...
                        surface.pixels[off as usize] = colour;
                        off += 1;
                    }
                }
                surface.pixels[off as usize] = colour;
