...
ROWS = {
    ...
    229: ("EVENT_MOUSE_MOVE", -1, ["p1 size", "sample p2 (dt<<12)|((dx+32)<<6)|(dy+32) when dt<8 and |dx|,|dy|<=31", "sample p3 (dt<<19)+y*765+x+0x800000 when dt<8 else abs mid", "sample p4 (dt<<19)+coord-0x40000000 when dt>=8", "psize1"], ["client.java mouse recorder method465(229)+method467/method469/method470+method475"], "verified-id-length-fields"),
