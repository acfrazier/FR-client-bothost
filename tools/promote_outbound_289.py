...
ROWS = {
    ...
    85: ("ANTICHEAT_CYCLELOGIC5", 0, [], ["client.java method465(85)"], "verified-id-length-fields"),
    ...
    93: ("CLOSE_MODAL", 0, [], ["client.java closeModal method465(93)"], "verified-id-length-fields"),
    94: ("SEND_SNAPSHOT", 10, ["p2*5 snapshot fields"], ["client.java method465(94)"], "verified-id-length-fields"),
    ...
    145: ("IDLE_TIMER", 0, [], ["client.java method465(145)"], "verified-id-length-fields"),
    ...
    181: ("NO_TIMEOUT", 0, [], ["client.java method465(181)"], "verified-id-length-fields"),
    ...
    192: ("IGNORELIST_ADD", 8, ["p8 userhash"], ["client.java method465(192) + method468"], "verified-id-length-fields"),
    193: ("EVENT_CAMERA_POSITION", 4, ["p2 yaw", "p2 pitch"], ["client.java method465(193)"], "verified-id-length-fields"),
    ...
    203: ("FRIENDLIST_DEL", 8, ["p8 userhash"], ["client.java method465(203) + method468"], "verified-id-length-fields"),
    214: ("MAP_BUILD_COMPLETE", 0, [], ["client.java map_build method465(214)"], "verified-id-length-fields"),
    ...
    224: ("EVENT_MOUSE_CLICK", 4, ["p2 x", "p2 y"], ["client.java method465(224)"], "verified-id-length-fields"),
    227: ("INV_BUTTON5", 6, ["p2 obj", "p2 slot", "p2 com"], ["client.java method216 method465(227) + three method467"], "verified-id-length-fields"),
    229: ("EVENT_MOUSE_MOVE", -1, ["p1 size", "move samples"], ["client.java method465(229)"], "verified-id-length-fields"),
    232: ("ANTICHEAT_CYCLELOGIC7", 1, ["p1 pad"], ["client.java method465(232)"], "verified-id-length-fields"),
    ...
    235: ("FRIENDLIST_ADD", 8, ["p8 userhash"], ["client.java method465(235) + method468"], "verified-id-length-fields"),
    ...
    251: ("IGNORELIST_DEL", 8, ["p8 userhash"], ["client.java method465(251) + method468"], "verified-id-length-fields"),
